/**
 * Domain-level exception used when services need to expose controlled failure messages.
 */
...
enum class ServiceErrorCode(
    ...
    CartQuantityNotHalfMeterMultiple(
        code = 2003,
        defaultMessage = "Invalid product quantity",
        defaultDescription = "Checkout product quantities must be multiples of 0.5 m2"
    ),
